...
\idx{``Pudim de Ameixas''}. Já em 1905, apenas um ano depois, Einstein formulou a
...
experimento \gls{glos:atlas} (do inglês, \eng{A Toroidal LHC Apparatus}) no
...
portas E/OU até \eng{Field-Programmable Gate Arrays} ou \gls{glos:fpga}'s. Os
...
\gls{glos:lhc} (\eng{Large Hadron Collider}).
...
\idxeng{High-Level Triggers}, \gls{glos:hlt}.
