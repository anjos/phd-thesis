...
para o classificador neural proposto. A relevância, como foi visto, mede o
impacto na classificação, quando se substitui uma das variáveis de entrada pela
...
relevantes para o discriminador neural. Para o caso das variáveis clássicas,
...
% por final, introduzindo a UFRJ no ATLAS/Trigger.

% Resumo do trabalho para doutorado:

% 1. Rodar T2Calo, fazer um re-estudo da primeira parte do chap 4, com os 
%    novos dados
% 2. Fazer os anéis, e um estudo comparativo
% 3. Fazer PCA, e estudo comparativo
% 4. Fazer ICA, e estudo comparativo
%
