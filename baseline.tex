...
dos dados ou Extração de Características (do inglês, \eng{Feature Extraction}
...
informação \eng{a priori} que maximizem a probabilidade de deteção das
...
são, entre outros, \eng{leptons} com carga e com momento transverso acima de
...
inglês \eng{Regions of Interest}), que guiarão o processo de seleção nos Altos
Níveis de Filtragem (do inglês, \eng{High-Level Triggers} ou HLT).
...
O \eng{trigger} de elétrons ou fótons conterá forte contaminação de jatos com
...
A Figura~\ref{fig:advanced-discriminator} esquematiza tal sistema de
...
computacional \eng{versus} qualidade de deteção.
