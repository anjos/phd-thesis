...
``cola'' foi criada entre o universo \eng{online}, onde eventos fluem pela
rede do Sistema de Filtragem e o universo
\eng{offline}, onde os algoritmos são desenvolvidos e testados. Esse sistema
...
preceitos: criação \eng{offline}, aplicação
...
dados faltantes e carência de sensores nas regiões de \eng{crack} de forma
