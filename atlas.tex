...
\idxfr{Conséil Européen pour la Recherche Nucléaire}) Provisório, com sede
prevista em um local próximo à Genebra, na Suíça. Dois anos após a ratificação
de uma convenção por seus \idx{Estados-Membros}, no dia 29 de maio de 1954, um
...
inglês \idxeng{Drift Chambers}). A criação desta tecnologia deu o Prêmio Nobel
...
ligada através de vários computadores. O nome \idx{World-Wide Web} foi
...
eletromagnéticas\index{força eletromagnética}. Carlo Rubia e Simon van der Meer
...
\idxeng{Large Electron-Positron Collider}, \idx{LEP}), com energia inicial
...
construção do \idx{Grande Colisionador de Hádrons} (do inglês \idxeng{Large
Hadron Collider}, LHC). A Figura~\ref{fig:accel} mostra o atual conjunto de
...
Os feixes do LHC serão armazenados por aproximadamente 10 horas em altas
...
\item \idx{\textbf{ALICE}}: estuda a física da matéria com fortes interações
em energias extremamente densas \cite{alice};

\item \idx{\textbf{LHCb}}: para realizar medidas precisas da violação CP e
decaimentos raros de hádrons B (compostos com o quark \eng{beauty}, ou
b-quark) \cite{lhcb};
...
\idx{bóson de Higgs}. Estes experimentos também incluem programas para estudo
...
período de aquisição programada ou \idxeng{run} durará cerca de 10 horas. Os
...
\idx{bóson de Higgs}. Esta partícula tem importância crítica para o Modelo
...
O papel do \idx{Detetor Interno} (do inglês \idxeng{Inner Detector},
...
\idx{pseudo-rapidez} (veja o Apêndice~\ref{ap:coord}) de $[-2,5; 2,5]$,
...
\idx{solenóide} com campo central de 2 Tesla.
...
Tracker}, \gls{glos:sct}), usando pastilhas\index{SCT!pastilhas} e
...
\idxeng{Straw Tube Tracker}, \gls{glos:trt}) que possibilita o
...
\begin{itemize}
\item \textbf{Eletromagnético ou \gls{glos:em}} (\eng{EM Accordion
Calorimeters}): Para a deteção de partículas que desenvolvem cascatas
e.m. como elétrons ou fótons, situando-se na parte mais interior da estrutura;

\item \textbf{Hadrônico} (\eng{Hadronic Tile Calorimeter} e \eng{Hadronic LAr
End Cap Calorimeter}): Para a deteção de partículas ou jatos que desenvolvam
cascatas baseadas em hádrons, como nêutrons, prótons e píons.

\item \textbf{\idx{Avançado} ou \idxeng{Forward}} (\eng{Foward \gls{glos:lar}
Calorimeters}): Para a deteção de partículas próximas ao eixo do feixe de
...
tubos foto-multiplicadores (PM)\index{tubos foto-multiplicadores}, onde o
