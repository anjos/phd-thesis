...
\idxfr{Centre Européen pour la Recherche Nucléaire}) Provisório, com sede
prevista em um local próximo à Genebra, na Suíça. Dois anos após a ratificação
de uma convenção por seus \idx{Estados-Membros}, no dia 29 de maio de 1954, o
...
\idxeng{Straw Tube Tracker}, \idx{TRT}) que possibilita o
...
\begin{itemize}
\item \textbf{Eletromagnético ou e.m.} (\eng{EM Accordion Calorimeters}): Para
...
\item \textbf{\idx{Avançado} ou \idxeng{Forward}} (\eng{Foward LAr
