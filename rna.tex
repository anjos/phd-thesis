...
na retropropagação de erros simples (do inglês \eng{back-propagation}) ou na
retropropagação resiliente (do inglês \eng{resilient
back-propagation}). Introduziremos o processo de treinamento destes sistemas à
seguir.
...
Atualização funciona, \eng{grosso modo}, da seguinte forma: 
