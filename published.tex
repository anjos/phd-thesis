...
re-utilização do ambiente de programação \eng{online} Athena dentro do sistema
...
Physics-Selection Software at the LHC}.} Este artigo foi apresentado no
 \eng{8\eiro ICATPP}. Referência \cite{aa:como-2003}.
...
\eng{Offline}. De forma a implementar um ambiente homogêneo de programação
...
\paragraph{Março de 2003: \eng{ATLAS-TDAQ DataCollection Software}} Este
trabalho foi publicado na revista \eng{IEEE Transactions on Nuclear
Sciences}. Referência \cite{aa:rt-2003}.
...
DAQ}} Este trabalho foi apresentado no congresso \eng{Computing for
High-Energy Physics' 2003}. Referência \cite{aa:chep-2003-2}.
