...
\eng{hardware} especializado, programas rodando em computadores genéricos,
...
exigem alguns \eng{megabytes} para cada evento registrado, o que representa
...
que podem separar \eng{online} os eventos de interesse dos eventos que
...
seguido de um \eng{micro-kernel} e, por fim, um programa a ser
...
Atualmente, algoritmos candidatos ao Sistema de Filtragem devem atender todas
as restrições, não somente de eficiência, mas também de tempo de execução,
integrando-se perfeitamente à pilha de \eng{software} do ATLAS. Uma vez tendo
...
\eng{software} \texttt{Neuralringer}, utilizado para as medidas de eficiência e
