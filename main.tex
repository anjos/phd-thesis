...
%% Tudo
%\includeonly{rosto, ficha, dedicatoria, resumo, conteudo, introducao,%
%fisica, atlas, trigger, baseline, neural, implement, conclusao,%
...
%implement, conclusao, coord-atlas, neuralringer, published}

%\includeonly{trigger, baseline, neural, implement, neuralringer, conclusao}
