...
%% Tudo
%%\includeonly{rosto, ficha, dedicatoria, resumo, conteudo, introducao, %
%%fisica, atlas, trigger, msc, futuro, coord-atlas, published, index}

%% Defesa de Tema 14 de julho de 2004
\input{title}
\includeonly{conteudo, introducao, fisica, atlas, trigger, baseline, neuralringer, conclusao, coord-atlas, published}
