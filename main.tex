...
%% Parte introdutória
%%\includeonly{rosto, ficha, dedicatoria, resumo, conteudo, glossario}

%% Conteúdo + capítulos + indice remissivo
\includeonly{conteudo, introducao, indice}

%% Tudo
%%\includeonly{rosto, ficha, dedicatoria, resumo, conteudo, introducao, indice}
