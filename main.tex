...
%% Parte introdutória
%%\includeonly{rosto, ficha, dedicatoria, resumo, conteudo, prefacio}

%% capítulo de interesse
%%\includeonly{prefacio}

%% Tudo
%%\includeonly{rosto, ficha, dedicatoria, resumo, conteudo, prefacio, %
%%introducao, atlas, trigger, msc, futuro, coord-atlas, published, index}

%% Defesa de Tema 14 de julho de 2004
\input{title}
%\includeonly{conteudo, prefacio,%
%introducao, atlas, trigger, neuralringer, futuro, coord-atlas, published}
\includeonly{neuralringer}
