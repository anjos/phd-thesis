...
\begin{figure}
\begin{center}
\includegraphics[scale=0.65,angle=-90]{dfbasic}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.7,angle=-90]{lvl2arch}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.8,angle=-90]{l2puarch}
\end{center}
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.8]{hlt-arch}
\end{center}
...
do detetor presentes no EF e \eng{offline}. A utilização transparente de tais
...
(\eng{LVL2 Steering Controller}, \gls{glos:l2sc}).
...
pré-processamento dos dados e sua conversão para o EDM (\eng{Data
conversion}), os \eng{overheads} da infraestrutura provida pelo HLT
(\eng{Steering}), processamento do algoritmo de extração de características
(denotado por \texttt{muFast} na figura) e o tempo de acesso dos dados pela
rede (\eng{Network latency}). As curvas mostram que, neste exemplo, o
