...
$\Sigma$ possui combinações lineares dos dados disponíveis, o \eng{rank} desta
...
\begin{figure}
\begin{center}
\includegraphics[scale=0.98]{lms/test-output-mse}
\end{center}
...
Nestas condições, o máximo produto SP para o conjunto de teste é 1,51,
...
AMD 64 com \eng{clock} de 2~GHz e 1~Gb de memória RAM. Ademais, tal sistema
...
conhecido como \eng{gap} ou \eng{crack} dos calorímetros), por onde passam os
...
% Falar da revisão da literatura brevemente, introduzir o processamento neural
% de leve e falar do NeuralRinger, nesta mesma seção. Material de Introdução à
% RNA's movido para apêndice
...
pacote \eng{NeuralRinger} e o fluxo de treinamento detalhado na
